...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('advertiser_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('advertiser', ['Category'])

        # Adding model 'Advertiser'
        db.create_table('advertiser_advertiser', (
            ('consumer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['consumer.Consumer'], unique=True, primary_key=True)),
            ('approval_count', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('advertiser_address1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('advertiser_address2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('advertiser_city', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True)),
            ('advertiser_state_province', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('advertiser_zip_postal', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True)),
            ('advertiser_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True)),
            ('advertiser_create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('advertiser_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('advertiser', ['Advertiser'])

        # Adding model 'Business'
        db.create_table('advertiser_business', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('short_business_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('slogan', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('business_create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('business_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('advertiser', ['Business'])

        # Adding M2M table for field category on 'Business'
        db.create_table('advertiser_business_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('business', models.ForeignKey(orm['advertiser.business'], null=False)),
            ('category', models.ForeignKey(orm['advertiser.category'], null=False))
        ))
        db.create_unique('advertiser_business_category', ['business_id', 'category_id'])

        # Adding model 'BillingRecord'
        db.create_table('advertiser_billingrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertiser.Business'])),
            ('alt_first_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('alt_last_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('alt_email', self.gf('django.db.models.fields.EmailField')(max_length=50, null=True, blank=True)),
            ('billing_address1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('billing_address2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('billing_city', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True)),
            ('billing_state_province', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('billing_zip_postal', self.gf('django.db.models.fields.CharField')(max_length=9)),
        ))
        db.send_create_signal('advertiser', ['BillingRecord'])

        # Adding model 'Location'
        db.create_table('advertiser_location', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertiser.Business'])),
            ('location_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('location_address1', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('location_address2', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('location_city', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('location_state_province', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('location_zip_postal', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True)),
            ('location_area_code', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('location_exchange', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('location_number', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('location_advertiser_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('location_description', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('location_create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('advertiser', ['Location'])


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table('advertiser_category')

        # Deleting model 'Advertiser'
        db.delete_table('advertiser_advertiser')

        # Deleting model 'Business'
        db.delete_table('advertiser_business')

        # Removing M2M table for field category on 'Business'
        db.delete_table('advertiser_business_category')

        # Deleting model 'BillingRecord'
        db.delete_table('advertiser_billingrecord')

        # Deleting model 'Location'
        db.delete_table('advertiser_location')
