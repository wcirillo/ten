...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Business.business_zip_postal'
        db.add_column('advertiser_business', 'business_zip_postal', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Business.business_zip_postal'
        db.delete_column('advertiser_business', 'business_zip_postal')
