...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Business.web_url'
        db.add_column('advertiser_business', 'web_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Business.web_url'
        db.delete_column('advertiser_business', 'web_url')
