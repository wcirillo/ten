...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BusinessProfileDescription'
        db.create_table('advertiser_businessprofiledescription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='business_profile_descriptions', to=orm['advertiser.Business'])),
            ('business_description', self.gf('django.db.models.fields.TextField')(max_length=400, null=True, blank=True)),
        ))
        db.send_create_signal('advertiser', ['BusinessProfileDescription'])

        # Adding field 'Business.show_web_snap'
        db.add_column('advertiser_business', 'show_web_snap', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Business.show_map'
        db.add_column('advertiser_business', 'show_map', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'BusinessProfileDescription'
        db.delete_table('advertiser_businessprofiledescription')

        # Deleting field 'Business.show_web_snap'
        db.delete_column('advertiser_business', 'show_web_snap')

        # Deleting field 'Business.show_map'
        db.delete_column('advertiser_business', 'show_map')
    ...
    models = {
        ...
        'advertiser.businessprofiledescription': {
            ...
            'business_description': ('django.db.models.fields.TextField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'advertiser.category': {
