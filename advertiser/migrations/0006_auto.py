...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Location', fields ['location_zip_postal']
        db.create_index('advertiser_location', ['location_zip_postal'])


    def backwards(self, orm):
        
        # Removing index on 'Location', fields ['location_zip_postal']
        db.delete_index('advertiser_location', ['location_zip_postal'])
