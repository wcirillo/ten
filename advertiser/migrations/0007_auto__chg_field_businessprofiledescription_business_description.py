...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BusinessProfileDescription.business_description'
        db.alter_column('advertiser_businessprofiledescription', 'business_description', self.gf('django.db.models.fields.TextField')(max_length=2500, null=True))


    def backwards(self, orm):
        
        # Changing field 'BusinessProfileDescription.business_description'
        db.alter_column('advertiser_businessprofiledescription', 'business_description', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))
