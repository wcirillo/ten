...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advertiser.advertiser_name'
        db.add_column('advertiser_advertiser', 'advertiser_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Advertiser.advertiser_area_code'
        db.add_column('advertiser_advertiser', 'advertiser_area_code', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'Advertiser.advertiser_exchange'
        db.add_column('advertiser_advertiser', 'advertiser_exchange', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'Advertiser.advertiser_number'
        db.add_column('advertiser_advertiser', 'advertiser_number', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advertiser.advertiser_name'
        db.delete_column('advertiser_advertiser', 'advertiser_name')

        # Deleting field 'Advertiser.advertiser_area_code'
        db.delete_column('advertiser_advertiser', 'advertiser_area_code')

        # Deleting field 'Advertiser.advertiser_exchange'
        db.delete_column('advertiser_advertiser', 'advertiser_exchange')

        # Deleting field 'Advertiser.advertiser_number'
        db.delete_column('advertiser_advertiser', 'advertiser_number')
    ...
    models = {
        ...
        'advertiser.businessprofiledescription': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'business_profile_descriptions'", 'to': "orm['advertiser.Business']"}),
