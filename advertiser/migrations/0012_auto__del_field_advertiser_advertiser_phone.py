...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Advertiser.advertiser_phone'
        db.delete_column('advertiser_advertiser', 'advertiser_phone')


    def backwards(self, orm):
        
        # Adding field 'Advertiser.advertiser_phone'
        db.add_column('advertiser_advertiser', 'advertiser_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True), keep_default=False)
