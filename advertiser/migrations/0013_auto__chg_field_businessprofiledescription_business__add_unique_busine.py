...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BusinessProfileDescription.business'
        db.alter_column('advertiser_businessprofiledescription', 'business_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['advertiser.Business']))

        # Adding unique constraint on 'BusinessProfileDescription', fields ['business']
        db.create_unique('advertiser_businessprofiledescription', ['business_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BusinessProfileDescription', fields ['business']
        db.delete_unique('advertiser_businessprofiledescription', ['business_id'])

        # Changing field 'BusinessProfileDescription.business'
        db.alter_column('advertiser_businessprofiledescription', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertiser.Business']))
