...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LocationCoordinates'
    ...
    models = {
        ...
        'advertiser.locationcoordinates': {
            'Meta': {'object_name': 'LocationCoordinates'},
            'location': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['advertiser.Location']", 'unique': 'True', 'primary_key': 'True'}),
