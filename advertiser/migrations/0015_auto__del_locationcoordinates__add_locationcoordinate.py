...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LocationCoordinate'
        db.create_table('advertiser_locationcoordinate', (
            ('location_latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=16)),
            ('location', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['advertiser.Location'], unique=True, primary_key=True)),
            ('location_longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=16)),
        ))
        db.send_create_signal('advertiser', ['LocationCoordinate'])
        cursor = connection.cursor()
        cursor.execute("INSERT INTO advertiser_locationcoordinate (location_id, location_latitude, location_longitude) \
                    SELECT location_id, location_latitude, location_longitude FROM advertiser_locationcoordinates")

        # Deleting model 'LocationCoordinate'
        db.delete_table('advertiser_locationcoordinates')


    def backwards(self, orm):
        
        # Adding model 'LocationCoordinates'
        db.create_table('advertiser_locationcoordinates', (
            ('location_latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=16)),
            ('location', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['advertiser.Location'], unique=True, primary_key=True)),
            ('location_longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=16)),
        ))
        db.send_create_signal('advertiser', ['LocationCoordinates'])
        cursor = connection.cursor()
        cursor.execute("INSERT INTO advertiser_locationcoordinates (location_id, location_latitude, location_longitude) \
                    SELECT location_id, location_latitude, location_longitude FROM advertiser_locationcoordinate")
        
        # Deleting model 'LocationCoordinate'
        db.delete_table('advertiser_locationcoordinate')
    ...
    models = {
        ...
        'advertiser.businessprofiledescription': {
            'Meta': {'object_name': 'BusinessProfileDescription'},
            'business': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'business_profile_description'", 'unique': 'True', 'to': "orm['advertiser.Business']"}),
            'business_description': ('django.db.models.fields.TextField', [], {'max_length': '2500', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'advertiser.location': {
        ...
        'advertiser.locationcoordinate': {
            'Meta': {'object_name': 'LocationCoordinate'},
            'location': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'location_coordinate'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['advertiser.Location']"}),
            'location_latitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '16'}),
            'location_longitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '16'})
        },
        'auth.group': {
