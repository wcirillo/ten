...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Location.location_advertiser_label'
        db.delete_column('advertiser_location', 'location_advertiser_label')


    def backwards(self, orm):
        
        # Adding field 'Location.location_advertiser_label'
        db.add_column('advertiser_location', 'location_advertiser_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
