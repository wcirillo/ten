...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming M2M table for field category on 'Business'
        db.rename_table('advertiser_business_category', 
            'advertiser_business_categories')

    def backwards(self, orm):
        # Renaming M2M table for field category on 'Business'
        db.rename_table('advertiser_business_categories', 
            'advertiser_business_category')
