...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Consumer.facebook_id'
        db.add_column('consumer_consumer', 'facebook_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Consumer.facebook_id'
        db.delete_column('consumer_consumer', 'facebook_id')
