...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Consumer.consumer_zip_postal'
        db.alter_column('auth_user', 'email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Consumer.consumer_zip_postal'
        db.alter_column('auth_user', 'email', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True))
    ...
    models = {
        ...
        'consumer.consumer': {
            ...
            'consumer_zip_postal': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
