...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Consumer.is_bouncing_email'
        db.add_column('consumer_consumer', 'is_bouncing_email', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Consumer.is_blacklisted'
        db.add_column('consumer_consumer', 'is_blacklisted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Consumer.is_perm_optout'
        db.add_column('consumer_consumer', 'is_perm_optout', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Consumer.is_bouncing_email'
        db.delete_column('consumer_consumer', 'is_bouncing_email')

        # Deleting field 'Consumer.is_blacklisted'
        db.delete_column('consumer_consumer', 'is_blacklisted')

        # Deleting field 'Consumer.is_perm_optout'
        db.delete_column('consumer_consumer', 'is_perm_optout')
