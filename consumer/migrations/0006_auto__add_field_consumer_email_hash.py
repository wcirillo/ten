...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Consumer.email_hash'
        db.add_column('consumer_consumer', 'email_hash', self.gf('django.db.models.fields.CharField')(max_length=42, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Consumer.email_hash'
        db.delete_column('consumer_consumer', 'email_hash')
