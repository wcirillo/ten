...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConsumerTrend.ranking'
        db.add_column('consumer_consumertrend', 'ranking', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConsumerTrend.ranking'
        db.delete_column('consumer_consumertrend', 'ranking')
