...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Consumer.consumer_modified_datetime'
        db.alter_column('consumer_consumer', 'consumer_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Consumer.consumer_modified_datetime'
        db.alter_column('consumer_consumer', 'consumer_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
