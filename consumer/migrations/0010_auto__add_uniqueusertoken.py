...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UniqueUserToken'
        db.create_table('consumer_uniqueusertoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['consumer.Consumer'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('hashstamp', self.gf('django.db.models.fields.CharField')(max_length=42, null=True, blank=True)),
            ('expires_in_seconds', self.gf('django.db.models.fields.IntegerField')(default=86400)),
        ))
        db.send_create_signal('consumer', ['UniqueUserToken'])


    def backwards(self, orm):
        
        # Deleting model 'UniqueUserToken'
        db.delete_table('consumer_uniqueusertoken')
    ...
    models = {
        ...
        'consumer.uniqueusertoken': {
            ...
            'expires_in_seconds': ('django.db.models.fields.IntegerField', [], {'default': '86400'}),
