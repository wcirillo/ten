...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UniqueUserToken.has_expiration'
        db.add_column('consumer_uniqueusertoken', 'has_expiration', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UniqueUserToken.has_expiration'
        db.delete_column('consumer_uniqueusertoken', 'has_expiration')
    ...
    models = {
        ...
        'consumer.uniqueusertoken': {
            ...
            'has_expiration': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
