...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ConsumerTrend'
        db.delete_table('consumer_consumertrend')


    def backwards(self, orm):
        
        # Adding model 'ConsumerTrend'
        db.create_table('consumer_consumertrend', (
        ...
        db.send_create_signal('consumer', ['ConsumerTrend'])
