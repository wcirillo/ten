...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Consumer.geolocation_type'
        db.add_column('consumer_consumer', 'geolocation_type', self.gf('django.db.models.fields.related.ForeignKey')(default=21, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Consumer.geolocation_id'
        db.add_column('consumer_consumer', 'geolocation_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Consumer.geolocation_type'
        db.delete_column('consumer_consumer', 'geolocation_type_id')

        # Deleting field 'Consumer.geolocation_id'
        db.delete_column('consumer_consumer', 'geolocation_id')
    ...
    models = {
        ...
        'consumer.consumer': {
            ...
            'geolocation_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '21', 'to': "orm['contenttypes.ContentType']"}),
