...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnEmailableReason'
        db.create_table('consumer_unemailablereason', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal('consumer', ['UnEmailableReason'])


    def backwards(self, orm):
        
        # Deleting model 'UnEmailableReason'
        db.delete_table('consumer_unemailablereason')
