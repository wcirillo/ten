...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Consumer.is_emailable'
        db.add_column('consumer_consumer', 'is_emailable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding M2M table for field nomail_reason on 'Consumer'
        db.create_table('consumer_consumer_nomail_reason', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('consumer', models.ForeignKey(orm['consumer.consumer'], null=False)),
            ('unemailablereason', models.ForeignKey(orm['consumer.unemailablereason'], null=False))
        ))
        db.create_unique('consumer_consumer_nomail_reason', ['consumer_id', 'unemailablereason_id'])


    def backwards(self, orm):
        
        # Deleting field 'Consumer.is_emailable'
        db.delete_column('consumer_consumer', 'is_emailable')

        # Removing M2M table for field nomail_reason on 'Consumer'
        db.delete_table('consumer_consumer_nomail_reason')
