...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('consumer_consumer', 'is_blacklisted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Consumer.is_perm_optout'
        db.add_column('consumer_consumer', 'is_perm_optout', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Consumer.is_bouncing_email'
        db.add_column('consumer_consumer', 'is_bouncing_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
