...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Consumer', fields ['is_emailable']
        db.create_index('consumer_consumer', ['is_emailable'])


    def backwards(self, orm):
        
        # Removing index on 'Consumer', fields ['is_emailable']
        db.delete_index('consumer_consumer', ['is_emailable'])
    ...
    models = {
        ...
        'consumer.consumer': {
            ...
            'email_subscription': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'consumers'", 'blank': 'True', 'db_index': 'True', 'to': "orm['consumer.EmailSubscription']"}),
