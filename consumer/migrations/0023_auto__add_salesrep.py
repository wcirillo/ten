...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('consumer_salesrep', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consumer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='salesreps', to=orm['consumer.Consumer'])),
            ('extension', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
        ))
        db.send_create_signal('consumer', ['SalesRep'])

        # Adding M2M table for field sites on 'SalesRep'
        db.create_table('consumer_salesrep_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('salesrep', models.ForeignKey(orm['consumer.salesrep'], null=False)),
            ('site', models.ForeignKey(orm['market.site'], null=False))
        ))
        db.create_unique('consumer_salesrep_sites', ['salesrep_id', 'site_id'])


    def backwards(self, orm):
        
        # Deleting model 'SalesRep'
        db.delete_table('consumer_salesrep')

        # Removing M2M table for field sites on 'SalesRep'
        db.delete_table('consumer_salesrep_sites')
