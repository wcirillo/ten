...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ConsumerHistoryEventType'
        db.create_table('consumer_consumerhistoryeventtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('consumer', ['ConsumerHistoryEventType'])

        # Adding model 'ConsumerHistoryEvent'
        db.create_table('consumer_consumerhistoryevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='history', to=orm['consumer.Consumer'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='evets', to=orm['consumer.ConsumerHistoryEventType'])),
            ('data', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('consumer', ['ConsumerHistoryEvent'])


    def backwards(self, orm):
        
        # Deleting model 'ConsumerHistoryEventType'
        db.delete_table('consumer_consumerhistoryeventtype')

        # Deleting model 'ConsumerHistoryEvent'
        db.delete_table('consumer_consumerhistoryevent')
    ...
    models = {
        ...
        'consumer.consumerhistoryevent': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'history'", 'to': "orm['consumer.Consumer']"})
        },
