...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ConsumerHistoryEvent.timestamp'
        db.delete_column('consumer_consumerhistoryevent', 'timestamp')

        # Deleting field 'ConsumerHistoryEvent.user'
        db.delete_column('consumer_consumerhistoryevent', 'user_id')

        # Adding field 'ConsumerHistoryEvent.consumer'
        db.add_column('consumer_consumerhistoryevent', 'consumer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='history', to=orm['consumer.Consumer']), keep_default=False)

        # Adding field 'ConsumerHistoryEvent.event_datetime'
        db.add_column('consumer_consumerhistoryevent', 'event_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 1, 14, 49, 15, 554538), blank=True), keep_default=False)

        # Adding field 'ConsumerHistoryEvent.ip'
        db.add_column('consumer_consumerhistoryevent', 'ip', self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ConsumerHistoryEvent.timestamp'
        db.add_column('consumer_consumerhistoryevent', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 11, 1, 14, 47, 38, 514281), blank=True), keep_default=False)

        # Adding field 'ConsumerHistoryEvent.user'
        db.add_column('consumer_consumerhistoryevent', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='history', to=orm['consumer.Consumer']), keep_default=False)

        # Deleting field 'ConsumerHistoryEvent.consumer'
        db.delete_column('consumer_consumerhistoryevent', 'consumer_id')

        # Deleting field 'ConsumerHistoryEvent.event_datetime'
        db.delete_column('consumer_consumerhistoryevent', 'event_datetime')

        # Deleting field 'ConsumerHistoryEvent.ip'
        db.delete_column('consumer_consumerhistoryevent', 'ip')
    ...
    models = {
        ...
        'consumer.consumerhistoryevent': {
            ...
            'data': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'event_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'event_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evets'", 'to': "orm['consumer.ConsumerHistoryEventType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.IPAddressField', [], {'default': "'0.0.0.0'", 'max_length': '15'})
        },
        'consumer.consumerhistoryeventtype': {
            'Meta': {'object_name': 'ConsumerHistoryEventType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
