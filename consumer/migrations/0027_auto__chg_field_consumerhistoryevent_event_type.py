...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ConsumerHistoryEvent.event_type' to match new field type.
        db.rename_column('consumer_consumerhistoryevent', 'event_type_id', 'event_type')
        # Changing field 'ConsumerHistoryEvent.event_type'
        db.alter_column('consumer_consumerhistoryevent', 'event_type', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Removing index on 'ConsumerHistoryEvent', fields ['event_type']
        db.delete_index('consumer_consumerhistoryevent', ['event_type_id'])


    def backwards(self, orm):
        
        # Adding index on 'ConsumerHistoryEvent', fields ['event_type']
        db.create_index('consumer_consumerhistoryevent', ['event_type_id'])

        # Renaming column for 'ConsumerHistoryEvent.event_type' to match new field type.
        db.rename_column('consumer_consumerhistoryevent', 'event_type', 'event_type_id')
        # Changing field 'ConsumerHistoryEvent.event_type'
        db.alter_column('consumer_consumerhistoryevent', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['consumer.ConsumerHistoryEventType']))
    ...
    models = {
        ...
        'consumer.consumerhistoryevent': {
            ...
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
