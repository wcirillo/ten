...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Flyer'
        db.create_table('coupon_flyer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sites', to=orm['market.Site'])),
        ...
        db.send_create_signal('coupon', ['Flyer'])

        # Adding model 'FlyerCoupon'
        db.create_table('coupon_flyercoupon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flyer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coupon.Flyer'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coupon.Coupon'])),
            ('rank', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, max_length=2)),
        ))
        db.send_create_signal('coupon', ['FlyerCoupon'])


    def backwards(self, orm):
        
        # Deleting model 'Flyer'
        db.delete_table('coupon_flyer')

        # Deleting model 'FlyerCoupon'
        db.delete_table('coupon_flyercoupon')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'coupon_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'coupons'", 'null': 'True', 'to': "orm['coupon.CouponType']"}),
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 8, 25)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'coupon': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'coupons'", 'symmetrical': 'False', 'through': "orm['coupon.FlyerCoupon']", 'to': "orm['coupon.Coupon']"}),
        ...
        'coupon.flyercoupon': {
            ...
            'flyer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coupon.Flyer']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
