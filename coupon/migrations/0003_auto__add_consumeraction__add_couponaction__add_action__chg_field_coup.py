...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ConsumerAction'
        db.create_table('coupon_consumeraction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consumer_actions', to=orm['coupon.Action'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consumer_actions', to=orm['coupon.Coupon'])),
            ('consumer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consumer_actions', to=orm['consumer.Consumer'])),
            ('create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('coupon', ['ConsumerAction'])

        # Adding model 'CouponAction'
        db.create_table('coupon_couponaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='coupon_actions', to=orm['coupon.Action'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='coupon_actions', to=orm['coupon.Coupon'])),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('coupon', ['CouponAction'])

        # Adding model 'Action'
        db.create_table('coupon_action', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('coupon', ['Action'])

        # Changing field 'Coupon.coupon_type'
        db.alter_column('coupon_coupon', 'coupon_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coupon.CouponType']))


    def backwards(self, orm):
        
        # Deleting model 'ConsumerAction'
        db.delete_table('coupon_consumeraction')

        # Deleting model 'CouponAction'
        db.delete_table('coupon_couponaction')

        # Deleting model 'Action'
        db.delete_table('coupon_action')

        # Changing field 'Coupon.coupon_type'
        db.alter_column('coupon_coupon', 'coupon_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['coupon.CouponType'], blank=True))
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 9, 19)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sites'", 'to': "orm['market.Site']"})
        },
        'coupon.flyercoupon': {
