...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ConsumerAction', fields ['action', 'coupon', 'consumer']
        db.create_unique('coupon_consumeraction', ['action_id', 'coupon_id', 'consumer_id'])

        # Adding unique constraint on 'CouponAction', fields ['action', 'coupon']
        db.create_unique('coupon_couponaction', ['action_id', 'coupon_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ConsumerAction', fields ['action', 'coupon', 'consumer']
        db.delete_unique('coupon_consumeraction', ['action_id', 'coupon_id', 'consumer_id'])

        # Removing unique constraint on 'CouponAction', fields ['action', 'coupon']
        db.delete_unique('coupon_couponaction', ['action_id', 'coupon_id'])
    ...
    models = {
        ...
        'coupon.consumeraction': {
            'Meta': {'unique_together': "(('action', 'coupon', 'consumer'),)", 'object_name': 'ConsumerAction'},
