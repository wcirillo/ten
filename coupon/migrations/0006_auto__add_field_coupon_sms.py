...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.sms'
        db.add_column('coupon_coupon', 'sms', self.gf('django.db.models.fields.CharField')(max_length=61, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.sms'
        db.delete_column('coupon_coupon', 'sms')
