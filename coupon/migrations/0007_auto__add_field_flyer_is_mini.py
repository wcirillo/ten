...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flyer.is_mini'
        db.add_column('coupon_flyer', 'is_mini', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Flyer.is_mini'
        db.delete_column('coupon_flyer', 'is_mini')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 10, 13)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
