...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flyer.num_recipients'
        db.add_column('coupon_flyer', 'num_recipients', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Flyer.num_recipients'
        db.delete_column('coupon_flyer', 'num_recipients')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 10, 25)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
