...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Flyer.is_sent'
        db.delete_column('coupon_flyer', 'is_sent')

        # Adding field 'Flyer.send_status'
        db.add_column('coupon_flyer', 'send_status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Flyer.is_sent'
        db.add_column('coupon_flyer', 'is_sent', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Flyer.send_status'
        db.delete_column('coupon_flyer', 'send_status')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 11, 23)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'send_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
