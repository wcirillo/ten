...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Flyer.send_status'
        db.alter_column('coupon_flyer', 'send_status', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'Flyer.send_status'
        db.alter_column('coupon_flyer', 'send_status', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 15)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
