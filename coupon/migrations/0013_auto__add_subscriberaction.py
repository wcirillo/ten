...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubscriberAction'
        db.create_table('coupon_subscriberaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_actions', to=orm['coupon.Action'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_actions', to=orm['coupon.Coupon'])),
            ('subscriber', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriber_actions', to=orm['subscriber.Subscriber'])),
            ('create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('coupon', ['SubscriberAction'])


    def backwards(self, orm):
        
        # Deleting model 'SubscriberAction'
        db.delete_table('coupon_subscriberaction')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 5)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
