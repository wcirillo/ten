...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlyerSubject'
        db.create_table('coupon_flyersubject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('week', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, max_length=2)),
        ))
        db.send_create_signal('coupon', ['FlyerSubject'])

        # Changing field 'Coupon.coupon_modified_datetime'
        db.alter_column('coupon_coupon', 'coupon_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Deleting model 'FlyerSubject'
        db.delete_table('coupon_flyersubject')

        # Changing field 'Coupon.coupon_modified_datetime'
        db.alter_column('coupon_coupon', 'coupon_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 10)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
