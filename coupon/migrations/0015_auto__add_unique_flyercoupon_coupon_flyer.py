...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FlyerCoupon', fields ['flyer', 'rank']
        db.create_unique('coupon_flyercoupon', ['flyer_id', 'rank'])
        # Adding unique constraint on 'FlyerCoupon', fields ['coupon', 'flyer']
        db.create_unique('coupon_flyercoupon', ['coupon_id', 'flyer_id'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'FlyerCoupon', fields ['flyer', 'rank']
        db.delete_unique('coupon_flyercoupon', ['flyer_id', 'rank'])
        # Removing unique constraint on 'FlyerCoupon', fields ['coupon', 'flyer']
        db.delete_unique('coupon_flyercoupon', ['coupon_id', 'flyer_id'])
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 19)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
