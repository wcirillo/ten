...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlyerSubject.send_date'
        db.add_column('coupon_flyersubject', 'send_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 12, 3), db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlyerSubject.send_date'
        db.delete_column('coupon_flyersubject', 'send_date')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 3, 3)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyersubject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 3)', 'db_index': 'True'}),
