...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SlotTimeframe'
        db.create_table('coupon_slottimeframe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slot_timeframes', to=orm['coupon.Slot'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slot_timeframes', to=orm['coupon.Coupon'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 17), db_index=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(db_index=True)),
        ))
        db.send_create_signal('coupon', ['SlotTimeframe'])

        # Adding model 'Slot'
        db.create_table('coupon_slot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slots', to=orm['market.Site'])),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slots', to=orm['advertiser.Business'])),
            ('renewal_rate', self.gf('django.db.models.fields.DecimalField')(default=10, max_digits=8, decimal_places=2)),
            ('is_autorenew', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 17), db_index=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(db_index=True)),
        ))
        db.send_create_signal('coupon', ['Slot'])


    def backwards(self, orm):
        
        # Deleting model 'SlotTimeframe'
        db.delete_table('coupon_slottimeframe')

        # Deleting model 'Slot'
        db.delete_table('coupon_slot')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 4, 17)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyersubject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 17)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 17)', 'db_index': 'True'})
        },
