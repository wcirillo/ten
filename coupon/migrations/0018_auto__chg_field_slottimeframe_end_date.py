...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SlotTimeframe.end_date'
        db.alter_column('coupon_slottimeframe', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'SlotTimeframe.end_date'
        db.alter_column('coupon_slottimeframe', 'end_date', self.gf('django.db.models.fields.DateField')())
