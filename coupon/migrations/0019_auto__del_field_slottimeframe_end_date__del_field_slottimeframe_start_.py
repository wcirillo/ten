...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SlotTimeframe.end_date'
        db.delete_column('coupon_slottimeframe', 'end_date')

        # Deleting field 'SlotTimeframe.start_date'
        db.delete_column('coupon_slottimeframe', 'start_date')

        # Adding field 'SlotTimeFrame.start_datetime'
        db.add_column('coupon_slottimeframe', 'start_datetime', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 1, 20, 16, 22, 22, 232101), db_index=True), keep_default=False)

        # Adding field 'SlotTimeFrame.end_datetime'
        db.add_column('coupon_slottimeframe', 'end_datetime', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SlotTimeframe.end_date'
        db.add_column('coupon_slottimeframe', 'end_date', self.gf('django.db.models.fields.DateField')(blank=True, null=True, db_index=True), keep_default=False)

        # Adding field 'SlotTimeframe.start_date'
        db.add_column('coupon_slottimeframe', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 17), db_index=True), keep_default=False)

        # Deleting field 'SlotTimeFrame.start_datetime'
        db.delete_column('coupon_slottimeframe', 'start_datetime')

        # Deleting field 'SlotTimeFrame.end_datetime'
        db.delete_column('coupon_slottimeframe', 'end_datetime')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 4, 20)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyersubject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 20)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 20)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            'Meta': {'object_name': 'SlotTimeFrame'},
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slot_timeframes'", 'to': "orm['coupon.Coupon']"}),
            'end_datetime': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slot_timeframes'", 'to': "orm['coupon.Slot']"}),
            'start_datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 1, 20, 16, 22, 22, 232101)', 'db_index': 'True'})
        },
