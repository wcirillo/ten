...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        #Set all send_datetimes with a default == create_datetime
        for flyer in orm.Flyer.objects.all():
            flyer.send_datetime = flyer.create_datetime
            flyer.save()
    ...
    models = {
        ...
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 9, 15, 18, 1, 93250)', 'db_index': 'True'})
        },
