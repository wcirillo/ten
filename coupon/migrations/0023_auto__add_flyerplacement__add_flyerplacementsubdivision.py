...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlyerPlacement'
        db.create_table('coupon_flyerplacement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flyer_placements', to=orm['market.Site'])),
            ('slot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flyer_placements', to=orm['coupon.Slot'])),
            ('week', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, max_length=2)),
        ))
        db.send_create_signal('coupon', ['FlyerPlacement'])

        # Adding model 'FlyerPlacementSubdivision'
        db.create_table('coupon_flyerplacementsubdivision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flyer_placement', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flyer_placement_subdivisions', to=orm['coupon.FlyerPlacement'])),
        ...
        db.send_create_signal('coupon', ['FlyerPlacementSubdivision'])


    def backwards(self, orm):
        
        # Deleting model 'FlyerPlacement'
        db.delete_table('coupon_flyerplacement')

        # Deleting model 'FlyerPlacementSubdivision'
        db.delete_table('coupon_flyerplacementsubdivision')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 2)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyerplacementsubdivision': {
            'Meta': {'object_name': 'FlyerPlacementSubdivision'},
        ...
        'coupon.flyersubject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 4)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 4)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 20, 15, 940802)', 'db_index': 'True'})
        },
