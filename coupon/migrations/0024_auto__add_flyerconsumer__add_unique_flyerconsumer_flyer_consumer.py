...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlyerConsumer'
        db.create_table('coupon_flyerconsumer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flyer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flyer_consumers', to=orm['coupon.Flyer'])),
            ('consumer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flyer_consumers', to=orm['consumer.Consumer'])),
        ))
        db.send_create_signal('coupon', ['FlyerConsumer'])

        # Adding unique constraint on 'FlyerConsumer', fields ['flyer', 'consumer']
        db.create_unique('coupon_flyerconsumer', ['flyer_id', 'consumer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FlyerConsumer', fields ['flyer', 'consumer']
        db.delete_unique('coupon_flyerconsumer', ['flyer_id', 'consumer_id'])

        # Deleting model 'FlyerConsumer'
        db.delete_table('coupon_flyerconsumer')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 4)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyerplacement': {
            ...
            'week': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '2'})
        },
        ...
        'coupon.flyersubject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 6)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 6)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 6, 13, 24, 52, 801395)', 'db_index': 'True'})
        },
