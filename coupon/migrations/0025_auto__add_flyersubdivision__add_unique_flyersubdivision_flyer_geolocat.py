...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlyerSubdivision'
        db.create_table('coupon_flyersubdivision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geolocation_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('geolocation_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('flyer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flyer_subdivisions', to=orm['coupon.Flyer'])),
        ))
        db.send_create_signal('coupon', ['FlyerSubdivision'])

        # Adding unique constraint on 'FlyerSubdivision', fields ['flyer', 'geolocation_type', 'geolocation_id']
        db.create_unique('coupon_flyersubdivision', ['flyer_id', 'geolocation_type_id', 'geolocation_id'])

        # Deleting field 'FlyerPlacement.week'
        db.delete_column('coupon_flyerplacement', 'week')

        # Adding field 'FlyerPlacement.send_date'
        db.add_column('coupon_flyerplacement', 'send_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 5, 12), db_index=True), keep_default=False)

        # Adding unique constraint on 'FlyerPlacementSubdivision', fields ['geolocation_type', 'geolocation_id', 'flyer_placement']
        db.create_unique('coupon_flyerplacementsubdivision', ['geolocation_type_id', 'geolocation_id', 'flyer_placement_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FlyerPlacementSubdivision', fields ['geolocation_type', 'geolocation_id', 'flyer_placement']
        db.delete_unique('coupon_flyerplacementsubdivision', ['geolocation_type_id', 'geolocation_id', 'flyer_placement_id'])

        # Removing unique constraint on 'FlyerSubdivision', fields ['flyer', 'geolocation_type', 'geolocation_id']
        db.delete_unique('coupon_flyersubdivision', ['flyer_id', 'geolocation_type_id', 'geolocation_id'])

        # Deleting model 'FlyerSubdivision'
        db.delete_table('coupon_flyersubdivision')

        # Adding field 'FlyerPlacement.week'
        db.add_column('coupon_flyerplacement', 'week', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length=2), keep_default=False)

        # Deleting field 'FlyerPlacement.send_date'
        db.delete_column('coupon_flyerplacement', 'send_date')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 11)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyerconsumer': {
            'Meta': {'unique_together': "(('flyer', 'consumer'),)", 'object_name': 'FlyerConsumer'},
            'consumer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flyer_consumers'", 'to': "orm['consumer.Consumer']"}),
            'flyer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flyer_consumers'", 'to': "orm['coupon.Flyer']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'coupon.flyercoupon': {
        ...
        'coupon.flyerplacement': {
            'Meta': {'object_name': 'FlyerPlacement'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flyer_placements'", 'to': "orm['market.Site']"}),
            'slot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flyer_placements'", 'to': "orm['coupon.Slot']"})
        },
        'coupon.flyerplacementsubdivision': {
            'Meta': {'unique_together': "(('flyer_placement', 'geolocation_type', 'geolocation_id'),)", 'object_name': 'FlyerPlacementSubdivision'},
            'flyer_placement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flyer_placement_subdivisions'", 'to': "orm['coupon.FlyerPlacement']"}),
            'geolocation_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'geolocation_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'coupon.flyersubdivision': {
            'Meta': {'unique_together': "(('flyer', 'geolocation_type', 'geolocation_id'),)", 'object_name': 'FlyerSubdivision'},
            'flyer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flyer_subdivisions'", 'to': "orm['coupon.Flyer']"}),
            'geolocation_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'geolocation_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'coupon.flyersubject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 13)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 13)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 8, 12, 51, 909544)', 'db_index': 'True'})
        },
