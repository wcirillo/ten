...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flyer.send_date'
        db.add_column('coupon_flyer', 'send_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 5, 23), db_index=True), keep_default=False)

        # Adding unique constraint on 'FlyerPlacement', fields ['slot', 'send_date']
        db.create_unique('coupon_flyerplacement', ['slot_id', 'send_date'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FlyerPlacement', fields ['slot', 'send_date']
        db.delete_unique('coupon_flyerplacement', ['slot_id', 'send_date'])

        # Deleting field 'Flyer.send_date'
        db.delete_column('coupon_flyer', 'send_date')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 21)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 23)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 23)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 23, 11, 10, 8, 791578)', 'db_index': 'True'})
        },
