...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Slot.parent_slot'
        db.add_column('coupon_slot', 'parent_slot', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='child_slots', null=True, blank=True, to=orm['coupon.Slot']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Slot.parent_slot'
        db.delete_column('coupon_slot', 'parent_slot_id')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 19)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 21)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 21)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 21, 16, 43, 34, 428550)', 'db_index': 'True'})
        },
