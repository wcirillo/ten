...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slot.renewal_rate'
        db.alter_column('coupon_slot', 'renewal_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Slot.renewal_rate'
        db.alter_column('coupon_slot', 'renewal_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 3)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 5)', 'db_index': 'True'}),
        ...
        'coupon.slot': {
            ...
            'renewal_rate': ('django.db.models.fields.DecimalField', [], {'default': '10', 'null': 'True', 'max_digits': '8', 'decimal_places': '2'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slots'", 'to': "orm['market.Site']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 5)', 'db_index': 'True'})
        },
        'coupon.slottimeframe': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 5, 14, 57, 28, 518517)', 'db_index': 'True'})
        },
