...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        #Make every slot a parent slot in the system
        for slot in orm.Slot.objects.all():
            slot.parent_slot = slot
            slot.save()
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 10)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
