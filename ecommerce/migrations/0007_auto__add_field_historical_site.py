...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Historical.site'
        db.add_column('ecommerce_historical', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='historicals', to=orm['market.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Historical.site'
        db.delete_column('ecommerce_historical', 'site_id')
    ...
    models = {
        ...
        'ecommerce.historical': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'historicals'", 'to': "orm['market.Site']"}),
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 26, 15, 50, 15, 356735)'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 7, 26)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 26)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
