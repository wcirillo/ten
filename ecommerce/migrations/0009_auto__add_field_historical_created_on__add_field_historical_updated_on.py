...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Historical.created_on'
        db.add_column('ecommerce_historical', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 7, 28), blank=True), keep_default=False)

        # Adding field 'Historical.updated_on'
        db.add_column('ecommerce_historical', 'updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2010, 7, 28), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Historical.created_on'
        db.delete_column('ecommerce_historical', 'created_on')

        # Deleting field 'Historical.updated_on'
        db.delete_column('ecommerce_historical', 'updated_on')
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 28, 13, 4, 37, 697953)'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 7, 28)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 28)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
