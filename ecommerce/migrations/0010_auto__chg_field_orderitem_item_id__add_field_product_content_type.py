...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.item_id'
        db.alter_column('ecommerce_orderitem', 'item_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Adding field 'Product.content_type'
        db.add_column('ecommerce_product', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'OrderItem.item_id'
        db.alter_column('ecommerce_orderitem', 'item_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Deleting field 'Product.content_type'
        db.delete_column('ecommerce_product', 'content_type_id')
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 14, 15, 30, 50, 82268)'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 9, 14)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 14)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
