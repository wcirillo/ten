...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        content_type_id = ContentType.objects.get(app_label="coupon", model="coupon").id
        
        # Adding field 'OrderItem.content_type'
        db.add_column('ecommerce_orderitem', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=content_type_id, to=orm['contenttypes.ContentType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.content_type'
        db.delete_column('ecommerce_orderitem', 'content_type_id')
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 15, 10, 39, 12, 399155)'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 9, 15)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 15)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
