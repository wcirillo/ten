...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Promoter.guid'
        db.add_column('ecommerce_promoter', 'guid', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Promoter.guid'
        db.delete_column('ecommerce_promoter', 'guid')
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 13, 39, 22, 542423)'}),
