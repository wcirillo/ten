...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Promotion.name'
        db.add_column('ecommerce_promotion', 'name', self.gf('django.db.models.fields.CharField')(max_length=48, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Promotion.name'
        db.delete_column('ecommerce_promotion', 'name')
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 26, 16, 1, 51, 648717)'}),
        ...
        'ecommerce.promotion': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '48', 'null': 'True', 'blank': 'True'}),
