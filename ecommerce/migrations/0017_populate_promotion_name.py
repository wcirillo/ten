...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for promotion in orm.Promotion.objects.all():
            promotion.name = promotion.description[:48]
            # Check for unicity as this will become a constraint:
            try:
                orm.Promotion.objects.get(name=promotion.name)
                promotion.name = promotion.id
            except orm.Promotion.DoesNotExist:
                pass
            promotion.save()
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 26, 16, 3, 1, 416086)'}),
