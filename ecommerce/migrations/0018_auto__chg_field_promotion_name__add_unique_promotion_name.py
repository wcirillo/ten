...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promotion.name'
        db.alter_column('ecommerce_promotion', 'name', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=48))

        # Adding unique constraint on 'Promotion', fields ['name']
        db.create_unique('ecommerce_promotion', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Promotion', fields ['name']
        db.delete_unique('ecommerce_promotion', ['name'])

        # Changing field 'Promotion.name'
        db.alter_column('ecommerce_promotion', 'name', self.gf('django.db.models.fields.CharField')(max_length=48, null=True))
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 26, 16, 22, 40, 955775)'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 26)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 7, 25)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
