...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Promotion', fields ['name']
        db.create_index('ecommerce_promotion', ['name'])

        # Adding index on 'Promoter', fields ['name']
        db.create_index('ecommerce_promoter', ['name'])

        # Adding index on 'PromotionCode', fields ['code']
        db.create_index('ecommerce_promotioncode', ['code'])


    def backwards(self, orm):
        
        # Removing index on 'PromotionCode', fields ['code']
        db.delete_index('ecommerce_promotioncode', ['code'])

        # Removing index on 'Promoter', fields ['name']
        db.delete_index('ecommerce_promoter', ['name'])

        # Removing index on 'Promotion', fields ['name']
        db.delete_index('ecommerce_promotion', ['name'])
    ...
    models = {
        ...
        'ecommerce.orderitem': {
            ...
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 3, 8, 58, 20, 579730)'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 3)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
