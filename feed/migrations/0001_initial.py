...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeedProvider'
        db.create_table('feed_feedprovider', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('feed_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('advertiser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='advertiser', to=orm['advertiser.Advertiser'])),
            ('create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('feed', ['FeedProvider'])

        # Adding model 'FeedCoupon'
        db.create_table('feed_feedcoupon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed_provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feed_coupons', to=orm['feed.FeedProvider'])),
            ...
            ('offer', self.gf('django.db.models.fields.CharField')(max_length=65)),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, db_index=True)),
            ('expiration_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 7, 4), db_index=True)),
            ('external_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('custom_restrictions', self.gf('django.db.models.fields.TextField')(max_length=400, null=True, blank=True)),
            ('create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('feed', ['FeedCoupon'])

        # Adding model 'FeedRelationship'
        db.create_table('feed_feedrelationship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed_provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feed_relationship', to=orm['feed.FeedProvider'])),
            ('feed_coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feed_relationship', to=orm['feed.FeedCoupon'])),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feed_relationship', to=orm['coupon.Coupon'])),
            ('create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('feed', ['FeedRelationship'])

        # Adding unique constraint on 'FeedRelationship', fields ['feed_coupon', 'coupon']
        db.create_unique('feed_feedrelationship', ['feed_coupon_id', 'coupon_id'])

        # Adding unique constraint on 'FeedRelationship', fields ['feed_coupon', 'feed_provider']
        db.create_unique('feed_feedrelationship', ['feed_coupon_id', 'feed_provider_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FeedRelationship', fields ['feed_coupon', 'feed_provider']
        db.delete_unique('feed_feedrelationship', ['feed_coupon_id', 'feed_provider_id'])

        # Removing unique constraint on 'FeedRelationship', fields ['feed_coupon', 'coupon']
        db.delete_unique('feed_feedrelationship', ['feed_coupon_id', 'coupon_id'])

        # Deleting model 'FeedProvider'
        db.delete_table('feed_feedprovider')

        # Deleting model 'FeedCoupon'
        db.delete_table('feed_feedcoupon')

        # Deleting model 'FeedRelationship'
        db.delete_table('feed_feedrelationship')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 4)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
