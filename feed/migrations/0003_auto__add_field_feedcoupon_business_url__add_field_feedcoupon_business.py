...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedCoupon.business_url'
        db.add_column('feed_feedcoupon', 'business_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FeedCoupon.business_description'
        db.add_column('feed_feedcoupon', 'business_description', self.gf('django.db.models.fields.TextField')(max_length=2500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedCoupon.business_url'
        db.delete_column('feed_feedcoupon', 'business_url')

        # Deleting field 'FeedCoupon.business_description'
        db.delete_column('feed_feedcoupon', 'business_description')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 17)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'feed.feedcoupon': {
            ...
            'business_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
