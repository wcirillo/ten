...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdRep'
        db.create_table('firestorm_adrep', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firestorm_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('consumer_points', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('firestorm', ['AdRep'])

        # Adding model 'AdRepAdvertiser'
        db.create_table('firestorm_adrepadvertiser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='advertisers', to=orm['firestorm.AdRep'])),
            ('advertiser', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['advertiser.Advertiser'], unique=True)),
        ))
        db.send_create_signal('firestorm', ['AdRepAdvertiser'])

        # Adding model 'AdRepOrder'
        db.create_table('firestorm_adreporder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['firestorm.AdRep'])),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ecommerce.Order'], unique=True)),
        ))
        db.send_create_signal('firestorm', ['AdRepOrder'])

        # Adding model 'AdRepConsumer'
        db.create_table('firestorm_adrepconsumer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consumers', to=orm['firestorm.AdRep'])),
            ('consumer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['consumer.Consumer'], unique=True)),
        ))
        db.send_create_signal('firestorm', ['AdRepConsumer'])


    def backwards(self, orm):
        
        # Deleting model 'AdRep'
        db.delete_table('firestorm_adrep')

        # Deleting model 'AdRepAdvertiser'
        db.delete_table('firestorm_adrepadvertiser')

        # Deleting model 'AdRepOrder'
        db.delete_table('firestorm_adreporder')

        # Deleting model 'AdRepConsumer'
        db.delete_table('firestorm_adrepconsumer')
    ...
    models = {
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 28)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 6, 27)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'firestorm.adrep': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '25'})
        },
        'firestorm.adrepadvertiser': {
            'Meta': {'object_name': 'AdRepAdvertiser'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'advertisers'", 'to': "orm['firestorm.AdRep']"}),
            'advertiser': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['advertiser.Advertiser']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'firestorm.adrepconsumer': {
            'Meta': {'object_name': 'AdRepConsumer'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'consumers'", 'to': "orm['firestorm.AdRep']"}),
            'consumer': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['consumer.Consumer']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'firestorm.adreporder': {
            'Meta': {'object_name': 'AdRepOrder'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': "orm['firestorm.AdRep']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ecommerce.Order']", 'unique': 'True'})
        },
