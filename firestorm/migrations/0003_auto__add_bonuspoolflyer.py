...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BonusPoolFlyer'
        db.create_table('firestorm_bonuspoolflyer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flyer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['coupon.Flyer'], unique=True)),
            ('calculate_status', self.gf('django.db.models.fields.CharField')(default='0', max_length=1)),
        ))
        db.send_create_signal('firestorm', ['BonusPoolFlyer'])


    def backwards(self, orm):
        
        # Deleting model 'BonusPoolFlyer'
        db.delete_table('firestorm_bonuspoolflyer')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 29)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 1)', 'db_index': 'True'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 1)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 6, 30)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
