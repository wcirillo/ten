...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdRepOrder.firestorm_order_id'
        db.add_column('firestorm_adreporder', 'firestorm_order_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdRepOrder.firestorm_order_id'
        db.delete_column('firestorm_adreporder', 'firestorm_order_id')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 31)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coupon.flyer': {
            ...
            'send_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 2)', 'db_index': 'True'}),
        ...
        'ecommerce.promoter': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 8, 2)'})
        },
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 1)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
