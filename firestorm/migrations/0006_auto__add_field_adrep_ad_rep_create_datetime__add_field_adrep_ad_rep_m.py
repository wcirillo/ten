...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdRep.ad_rep_create_datetime'
        db.add_column('firestorm_adrep', 'ad_rep_create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 8, 10, 9, 27, 33, 988615), blank=True), keep_default=False)

        # Adding field 'AdRep.ad_rep_modified_datetime'
        db.add_column('firestorm_adrep', 'ad_rep_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 8, 10, 9, 27, 45, 840616), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdRep.ad_rep_create_datetime'
        db.delete_column('firestorm_adrep', 'ad_rep_create_datetime')

        # Deleting field 'AdRep.ad_rep_modified_datetime'
        db.delete_column('firestorm_adrep', 'ad_rep_modified_datetime')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 8)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 9)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
