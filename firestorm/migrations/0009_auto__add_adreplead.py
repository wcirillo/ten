...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdRepLead'
        db.create_table('firestorm_adreplead', (
            ('consumer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['consumer.Consumer'], unique=True, primary_key=True)),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ad_rep_leads', null=True, to=orm['firestorm.AdRep'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal('firestorm', ['AdRepLead'])


    def backwards(self, orm):
        
        # Deleting model 'AdRepLead'
        db.delete_table('firestorm_adreplead')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 14)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 14)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
