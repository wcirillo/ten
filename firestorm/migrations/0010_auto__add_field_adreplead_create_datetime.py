...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdRepLead.create_datetime'
        db.add_column('firestorm_adreplead', 'create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 27), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdRepLead.create_datetime'
        db.delete_column('firestorm_adreplead', 'create_datetime')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 26)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 26)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
