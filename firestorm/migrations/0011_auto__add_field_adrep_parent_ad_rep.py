...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdRep.parent_ad_rep'
        db.add_column('firestorm_adrep', 'parent_ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firestorm.AdRep'], null=True, blank=True), keep_default=False)

        # Removing index on 'AdRep', fields ['mailing_zip_postal']
        db.delete_index('firestorm_adrep', ['mailing_zip_postal'])


    def backwards(self, orm):
        
        # Adding index on 'AdRep', fields ['mailing_zip_postal']
        db.create_index('firestorm_adrep', ['mailing_zip_postal'])

        # Deleting field 'AdRep.parent_ad_rep'
        db.delete_column('firestorm_adrep', 'parent_ad_rep_id')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 29)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 29)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
