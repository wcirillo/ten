...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdRepUSState'
        db.create_table('firestorm_adrepusstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ad_rep_states', to=orm['firestorm.AdRep'])),
            ('us_state', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ad_rep_states', unique=True, to=orm['geolocation.USState'])),
        ))
        db.send_create_signal('firestorm', ['AdRepUSState'])


    def backwards(self, orm):
        
        # Deleting model 'AdRepUSState'
        db.delete_table('firestorm_adrepusstate')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 16)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 17)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
