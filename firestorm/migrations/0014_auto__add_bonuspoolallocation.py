...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BonusPoolAllocation'
        db.create_table('firestorm_bonuspoolallocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep_order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bonus_pool_allocations', to=orm['firestorm.AdRepOrder'])),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bonus_pool_allocations', to=orm['firestorm.AdRep'])),
            ('consumer_points', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal('firestorm', ['BonusPoolAllocation'])


    def backwards(self, orm):
        
        # Deleting model 'BonusPoolAllocation'
        db.delete_table('firestorm_bonuspoolallocation')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 22)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 23)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
