...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdRep.us_zip'
        db.add_column('firestorm_adrep', 'us_zip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geolocation.USZip'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdRep.us_zip'
        db.delete_column('firestorm_adrep', 'us_zip_id')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 23)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 24)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
