...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdRepLead.is_commission_ok'
        db.add_column('firestorm_adreplead', 'is_commission_ok', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AdRepLead.sales_ability_rating'
        db.add_column('firestorm_adreplead', 'sales_ability_rating', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)

        # Adding field 'AdRepLead.right_person_text'
        db.add_column('firestorm_adreplead', 'right_person_text', self.gf('django.db.models.fields.TextField')(max_length=2500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdRepLead.is_commission_ok'
        db.delete_column('firestorm_adreplead', 'is_commission_ok')

        # Deleting field 'AdRepLead.sales_ability_rating'
        db.delete_column('firestorm_adreplead', 'sales_ability_rating')

        # Deleting field 'AdRepLead.right_person_text'
        db.delete_column('firestorm_adreplead', 'right_person_text')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 3, 5)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 12, 5)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
