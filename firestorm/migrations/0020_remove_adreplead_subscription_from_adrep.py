...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        ad_reps = orm.AdRep.objects.filter(email_subscription__id=5)
        if ad_reps:
            LOG.info('Removing adreplead subscription from %s ad reps' 
                % len(ad_reps))
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 3, 13)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 12, 13)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
