...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdRepSite'
        db.create_table('firestorm_adrepsite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ad_rep_sites', to=orm['firestorm.AdRep'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ad_rep_sites', unique=True, to=orm['market.Site'])),
        ))
        db.send_create_signal('firestorm', ['AdRepSite'])


    def backwards(self, orm):
        
        # Deleting model 'AdRepSite'
        db.delete_table('firestorm_adrepsite')
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 4, 2)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 1, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
