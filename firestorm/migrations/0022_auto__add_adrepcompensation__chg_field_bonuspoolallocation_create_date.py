...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdRepCompensation'
        db.create_table('firestorm_adrepcompensation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_rep_order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ad_rep_compensations', to=orm['firestorm.AdRepOrder'])),
            ('ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ad_rep_compensations', to=orm['firestorm.AdRep'])),
            ('child_ad_rep', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_ad_rep_compensations', null=True, to=orm['firestorm.AdRep'])),
        ...
        db.send_create_signal('firestorm', ['AdRepCompensation'])

        # Changing field 'BonusPoolAllocation.create_datetime'
        db.alter_column('firestorm_bonuspoolallocation', 'create_datetime', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Deleting model 'AdRepCompensation'
        db.delete_table('firestorm_adrepcompensation')

        # Changing field 'BonusPoolAllocation.create_datetime'
        db.alter_column('firestorm_bonuspoolallocation', 'create_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
