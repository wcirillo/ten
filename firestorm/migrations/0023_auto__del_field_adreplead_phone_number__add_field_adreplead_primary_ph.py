...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'AdRep', fields ['firestorm_id']
        db.delete_unique('firestorm_adrep', ['firestorm_id'])

        # Rename 'AdRepLead.phone_number'
        db.rename_column('firestorm_adreplead', 'phone_number', 'primary_phone_number')

        # Rename 'AdRep.work_phone_number'
        db.rename_column('firestorm_adrep', 'work_phone_number', 'primary_phone_number')
        
        # Adding field 'AdRep.ad_rep_photo'
        db.add_column('firestorm_adrep', 'ad_rep_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'AdRep.firestorm_id'
        db.alter_column('firestorm_adrep', 'firestorm_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Rename 'AdRepLead.phone_number'
        db.rename_column('firestorm_adreplead', 'primary_phone_number', 'phone_number')

        # Rename 'AdRep.work_phone_number'
        db.rename_column('firestorm_adrep', 'primary_phone_number', 'work_phone_number')

        # Deleting field 'AdRep.ad_rep_photo'
        db.delete_column('firestorm_adrep', 'ad_rep_photo')

        # Changing field 'AdRep.firestorm_id'
        db.alter_column('firestorm_adrep', 'firestorm_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, unique=True))

        # Adding unique constraint on 'AdRep', fields ['firestorm_id']
        db.create_unique('firestorm_adrep', ['firestorm_id'])
    ...
    models = {
        ...
        'coupon.coupon': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 5, 1)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ecommerce.promotion': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 1, 31)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'firestorm.adrep': {
            ...
            'ad_rep_create_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'ad_rep_modified_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'ad_rep_photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'cell_phone_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'firestorm_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'mailing_zip_postal': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True', 'blank': 'True'}),
            'parent_ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['firestorm.AdRep']", 'null': 'True', 'blank': 'True'}),
            'primary_phone_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'rank': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
            'us_zip': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geolocation.USZip']", 'null': 'True', 'blank': 'True'}),
        ...
        'firestorm.adrepcompensation': {
            'Meta': {'object_name': 'AdRepCompensation'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ad_rep_compensations'", 'to': "orm['firestorm.AdRep']"}),
            'ad_rep_order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ad_rep_compensations'", 'to': "orm['firestorm.AdRepOrder']"}),
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'child_ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'parent_ad_rep_compensations'", 'null': 'True', 'to': "orm['firestorm.AdRep']"}),
        ...
        'firestorm.adreplead': {
            'Meta': {'object_name': 'AdRepLead', '_ormbases': ['consumer.Consumer']},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ad_rep_leads'", 'null': 'True', 'to': "orm['firestorm.AdRep']"}),
            'consumer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['consumer.Consumer']", 'unique': 'True', 'primary_key': 'True'}),
            'create_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'is_commission_ok': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'primary_phone_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'right_person_text': ('django.db.models.fields.TextField', [], {'max_length': '2500', 'null': 'True', 'blank': 'True'}),
            'sales_ability_rating': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'})
        },
        ...
        'firestorm.adrepsite': {
            'Meta': {'object_name': 'AdRepSite'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ad_rep_sites'", 'to': "orm['firestorm.AdRep']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ad_rep_sites'", 'unique': 'True', 'to': "orm['market.Site']"})
        },
        'firestorm.adrepusstate': {
            'Meta': {'object_name': 'AdRepUSState'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ad_rep_states'", 'to': "orm['firestorm.AdRep']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'us_state': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ad_rep_states'", 'unique': 'True', 'to': "orm['geolocation.USState']"})
        },
        ...
        'firestorm.bonuspoolallocation': {
            'Meta': {'object_name': 'BonusPoolAllocation'},
            'ad_rep': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bonus_pool_allocations'", 'to': "orm['firestorm.AdRep']"}),
            'ad_rep_order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bonus_pool_allocations'", 'to': "orm['firestorm.AdRepOrder']"}),
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'consumer_points': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'create_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
