...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.broadcaster_allotment'
        db.delete_column('market_site', 'broadcaster_allotment')

        # Adding field 'Site.media_partner_allotment'
        db.add_column('market_site', 'media_partner_allotment', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Site.broadcaster_allotment'
        db.add_column('market_site', 'broadcaster_allotment', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'Site.media_partner_allotment'
        db.delete_column('market_site', 'media_partner_allotment')
