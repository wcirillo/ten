...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.coordinate'
        db.add_column('market_site', 'coordinate', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sites', null=True, to=orm['geolocation.Coordinate']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.coordinate'
        db.delete_column('market_site', 'coordinate_id')
