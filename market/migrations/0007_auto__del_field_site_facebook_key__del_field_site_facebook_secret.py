...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.facebook_secret'
        db.delete_column('market_site', 'facebook_secret')


    def backwards(self, orm):
        
        # Adding field 'Site.facebook_key'
        db.add_column('market_site', 'facebook_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Site.facebook_secret'
        db.add_column('market_site', 'facebook_secret', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, null=True, blank=True), keep_default=False)
