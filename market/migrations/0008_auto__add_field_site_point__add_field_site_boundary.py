...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.point'
        db.add_column('market_site', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

        # Adding field 'Site.boundary'
        db.add_column('market_site', 'boundary', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.point'
        db.delete_column('market_site', 'point')

        # Deleting field 'Site.boundary'
        db.delete_column('market_site', 'boundary')
    ...
    models = {
        ...
        'market.site': {
            ...
            'boundary': ('django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'}),
