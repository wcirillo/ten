...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.envelope'
        db.add_column('market_site', 'envelope', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.envelope'
        db.delete_column('market_site', 'envelope')
