...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('market_twitteraccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.OneToOneField')(related_name='twitter_account', unique=True, to=orm['market.Site'])),
            ('twitter_name', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True, null=True, blank=True)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('consumer_key', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('consumer_secret', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('access_key', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('access_secret', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('market', ['TwitterAccount'])


    def backwards(self, orm):
        
        # Deleting model 'TwitterAccount'
        db.delete_table('market_twitteraccount')
    ...
    models = {
        ...
        'market.twitteraccount': {
            ...
            'site': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'twitter_accounts'", 'unique': 'True', 'to': "orm['market.Site']"}),
            'twitter_name': ('django.db.models.fields.CharField', [], {'max_length': '15', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
