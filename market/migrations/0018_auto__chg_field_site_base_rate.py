...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.base_rate'
        db.alter_column('market_site', 'base_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=0))


    def backwards(self, orm):
        
        # Changing field 'Site.base_rate'
        db.alter_column('market_site', 'base_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=0))
