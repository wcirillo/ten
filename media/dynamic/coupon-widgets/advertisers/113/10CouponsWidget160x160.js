...
function main() {
    jQuery(document).ready(function($) {
        ...
        var container = '#coupon-container-small-square';
        var wrapper = 'coupon-wrapper-small-square';
        var set = 'small-square';
        var buttons = 'Horiz';
        ...
        if (num_coupons > 0){
            ...
            $('#' + wrapper).append("<div class='no_coupon_content' id='coupon_" + set + "_1'>Sign up to get 10 local coupons sent to your email inbox every week!<br/><a class='coupons-btn' href='" + data.site_url + "' target='_parent'>Sign Up Now!</a></div>")
        }
