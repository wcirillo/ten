...
function main() {
    jQuery(document).ready(function($) {
        ...
        /******* Coupon Data *******/
        var data =  {"site_name": "Hudson Valley", "site_name_no_spaces": "HudsonValley", "coupons": [{"headline": "A lot of stuff", "business_name": "Phillips Toolshed", "coupon_url": "http://local.10coupons.com/hudson-valley/coupon-phillips-toolshed-lot-stuff/411/", "qualifier": "Free with item purchase"}], "site_url": "http://local.10coupons.com/hudson-valley/"} 

		var container = '#coupon-container-skyscraper';
		var wrapper = 'coupon-wrapper-skyscraper';
		var set = 'skyscraper';
		var buttons = 'Horiz';
        ...
        if (num_coupons > 0){
            num_sets = Math.ceil(num_coupons/3);
        }else{
            num_sets = 1;
        }
        var k = 0;

        $(container).append("<div class='alt_content'>Eat. Drink. Play. Shop. Save Money.<br/><span class='coupons-highlight'>WIN $10,000!*</span><br/>Get 10 local coupons sent to your email inbox every week!<br/><span class='coupons-smalltext'>*See <a class='coupons-link' href='" + data.site_url + "rules/' target='_parent'>rules</a> for details</span><br/><br/><a class='coupons-btn' href='" + data.site_url + "' target='_parent'>Sign Up Now!</a><br/><br/>Own a business? Reach local customers in our weekly Email Flyer!<br/><br/><a class='coupons-btn' href='" + data.site_url + "create-coupon/' target='_parent'>Create a Coupon!</a></div>")
