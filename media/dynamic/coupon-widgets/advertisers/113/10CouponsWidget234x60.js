...
function main() {
    jQuery(document).ready(function($) {
		...
		var container = '#coupon-container-half';
		var wrapper = 'coupon-wrapper-half';
		var set = 'half';
		var buttons = 'Horiz';
        ...
        if (num_coupons > 0){
            ...
            $('#' + wrapper).append("<div class='no_coupon_content' id='coupon_" + set + "_1'>Get 10 local coupons sent to your email inbox every week! <a class='coupons-link' href='" + data.site_url + "' target='_parent'>Sign Up Now!</a></div>")
        }
