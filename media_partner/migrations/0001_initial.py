...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('media_partner_mediagroup', (
        ...
        db.send_create_signal('media_partner', ['MediaGroup'])
        ...
        # Adding model 'Medium'
        db.create_table('media_partner_medium', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('media_partner', ['Medium'])

        # Adding model 'Affiliate'
        db.create_table('media_partner_affiliate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('media_group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='affiliates', null=True, to=orm['media_partner.MediaGroup'])),
            ('contact_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('contact_phone', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('contact_email', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('state_province', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('zip_postal', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True)),
            ('media_pie_share', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('free_coupons', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('medium', self.gf('django.db.models.fields.related.ForeignKey')(related_name='affiliates', to=orm['media_partner.Medium'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='affiliates', to=orm['market.Site'])),
        ))
        db.send_create_signal('media_partner', ['Affiliate'])
        ...
        # Adding model 'Outlet'
        db.create_table('media_partner_outlet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('affiliate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outlets', to=orm['media_partner.Affiliate'])),
            ('band', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('slogan', self.gf('django.db.models.fields.TextField')(max_length=50)),
            ('website', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('media_partner', ['Outlet'])


    def backwards(self, orm):
        
        # Deleting model 'MediaGroup'
        db.delete_table('media_partner_mediagroup')

        # Removing M2M table for field users on 'MediaGroup'
        db.delete_table('media_partner_mediagroup_users')

        # Deleting model 'Medium'
        db.delete_table('media_partner_medium')

        # Deleting model 'Affiliate'
        db.delete_table('media_partner_affiliate')

        # Removing M2M table for field users on 'Affiliate'
        db.delete_table('media_partner_affiliate_users')

        # Deleting model 'Outlet'
        db.delete_table('media_partner_outlet')
    ...
    models = {
        ...
        'media_partner.affiliate': {
            ...
            'media_pie_share': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'affiliates'", 'symmetrical': 'False', 'to': "orm['consumer.Consumer']"}),
        ...
        'media_partner.mediagroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['consumer.Consumer']", 'symmetrical': 'False'})
        },
