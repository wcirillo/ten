...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MediaPieShare'
        db.create_table('media_partner_mediapieshare', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('affiliate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_pie_shares', to=orm['media_partner.Affiliate'])),
            ('share', self.gf('django.db.models.fields.DecimalField')(default=0.20000000000000001, max_digits=2, decimal_places=2)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_pie_shares', to=orm['market.Site'])),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('media_partner', ['MediaPieShare'])


    def backwards(self, orm):
        
        # Deleting model 'MediaPieShare'
        db.delete_table('media_partner_mediapieshare')
    ...
    models = {
        ...
        'media_partner.mediapieshare': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'share': ('django.db.models.fields.DecimalField', [], {'default': '0.20000000000000001', 'max_digits': '2', 'decimal_places': '2'}),
