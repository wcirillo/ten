...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Affiliate.media_pie_share'
        db.delete_column('media_partner_affiliate', 'media_pie_share')


    def backwards(self, orm):
        
        # Adding field 'Affiliate.media_pie_share'
        db.add_column('media_partner_affiliate', 'media_pie_share', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'media_partner.affiliate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'media_groups'", 'null': 'True', 'to': "orm['media_partner.MediaGroup']"}),
        ...
        'media_partner.mediagroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'media_groups'", 'symmetrical': 'False', 'to': "orm['consumer.Consumer']"})
        },
