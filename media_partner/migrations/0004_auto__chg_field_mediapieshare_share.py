...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaPieShare.share'
        db.alter_column('media_partner_mediapieshare', 'share', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'MediaPieShare.share'
        db.alter_column('media_partner_mediapieshare', 'share', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=2))
