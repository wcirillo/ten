...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for subscriber in orm.Subscriber.objects.all():
            mobile_phone = subscriber.mobile_phone
            mobile_phone.subscriber_id = subscriber.id
            mobile_phone.save()        

    def backwards(self, orm):
        "Write your backwards methods here."
        for mobile_phone in orm.MobilePhone.objects.all():
            subscriber = Subscriber.objects.get(id=mobile_phone.subscriber_id)
