...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subscriber.mobile_phone'
        db.delete_column('subscriber_subscriber', 'mobile_phone_id')


    def backwards(self, orm):
        
        # Adding field 'Subscriber.mobile_phone'
        db.add_column('subscriber_subscriber', 'mobile_phone', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subscribers', to=orm['subscriber.MobilePhone'], blank=True), keep_default=False)
