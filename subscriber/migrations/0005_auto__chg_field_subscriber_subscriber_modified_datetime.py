...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscriber.subscriber_modified_datetime'
        db.alter_column('subscriber_subscriber', 'subscriber_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Changing field 'Subscriber.subscriber_modified_datetime'
        db.alter_column('subscriber_subscriber', 'subscriber_modified_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
