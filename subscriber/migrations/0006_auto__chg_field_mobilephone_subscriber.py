...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MobilePhone.subscriber'
        db.alter_column('subscriber_mobilephone', 'subscriber_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['subscriber.Subscriber']))


    def backwards(self, orm):
        
        # Changing field 'MobilePhone.subscriber'
        db.alter_column('subscriber_mobilephone', 'subscriber_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['subscriber.Subscriber']))
    ...
    models = {
        ...
        'subscriber.mobilephone': {
            ...
            'subscriber': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'mobile_phones'", 'null': 'True', 'to': "orm['subscriber.Subscriber']"})
        },
